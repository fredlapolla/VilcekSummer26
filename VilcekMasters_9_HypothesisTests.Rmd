...
If we have a small sample under 30 (which in this case we have a large sample) and non-normally distributed data we may need to choose a non-parametric test. Other options do exist such as boot-strapping approaches, but for now we will focus on the non-parametric tests.
